...
export const createMocks = () => {
	...
	movieCast.push({ movieId: 'iron_man', castMemberId: 'favreau', role: 'Director/Actor', character: 'Happy Hogan' });
	...
	movieCast.push({ movieId: 'sherlock_holmes', castMemberId: 'downey', role: 'Actor', character: 'Sherlock Holmes' });
