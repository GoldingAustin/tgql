import type { Expand, UndefinedAsOptional, tGQLOutputTypes } from '../../types.ts';
import { GraphQLTypeMap, tGQLObjectFieldsBase } from '../../types.ts';
...
> {
	...
	public extends<Interfaces extends tGQLInterface<any>>(
		...
		return new tGQLObject(this.name, { ...this.fields, ...tgqlInterface.fields }, [...this.interfaces, tgqlInterface]);
	}
}
