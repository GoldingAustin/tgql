...
import { type tGQLObject, tGQLNonNull, tGQLFieldResolver, tGQLNullableBase } from './index.ts';
import { tGQLBaseTypeAny } from '../types.ts';
...
type GetMatchingKeys<T extends tGQLObject<any>['fields']> = {
	[K in
		keyof T as T[K] extends tGQLFieldResolver<any, any, any> | tGQLNullableBase<tGQLFieldResolver<any, any, any>>
			? never
			: K]: T[K];
};
